...
type ActionIconType = "refresh" | "like" | "dislike" | "copy" | "share";
...
const icons: Record<ActionIconType, React.ReactNode> = {
  ...
  dislike: <path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-3" />,
  copy: (
    <>
...
export function ActionIcon({ type, onClick }: ActionIconProps) {
  return (
    <button
      onClick={onClick}
