...
export function ChatInput({ value, onChange, onSubmit, compact = false }: ChatInputProps) {
  return (
    <form
      onSubmit={onSubmit}
      className={`relative z-10 w-full transition-all duration-500 ${compact ? "max-w-full" : "max-w-2xl"}`}
    >
      <div
